...
! function (t, e) {
    ...
    for (var b = {
        ...
        return function (e, i, n) {
            if ("H" == t) e[0] = e[0] + i.x;
                ...
                for (var r = 0, s = e.length; r < s; ++r) e[r] = e[r] + (r % 2 ? i.y : i.x);
            return b[t](e, i, n)
        }
    }(C[N].toUpperCase());
    w.PathArray = function (t, e) {
        ...
        parse: function (t) {
            ...
            var n = [],
                ...
                h = t.length;
            do {
                w.regex.isPathLetter.test(t[a]) ? (e = t[a], ++a) : "M" == e ? e = "L" : "m" == e && (e = "l"), n.push(b[e].call(null, t.slice(a, a += r[e.toUpperCase()]).map(parseFloat), s, o))
            } while (h > a);
            return n
        },
        bbox: function () {
        ...
        extend: {
            ...
            initAnimations: function () {
                ...
                for (t in n.animations)
                    for (i = this.target()[t](), Array.isArray(i) || (i = [i]), Array.isArray(n.animations[t]) || (n.animations[t] = [n.animations[t]]), e = i.length; e--;) n.animations[t][e] instanceof w.Number && (i[e] = new w.Number(i[e])), n.animations[t][e] = i[e].morph(n.animations[t][e]);
            ...
            step: function (t) {
                if (t || (this.absPos = this.timeToAbsPos(+new Date)), !1 !== this.situation.loops) {
                    var e, i, n;
                    e = Math.max(this.absPos, 0), i = Math.floor(e), !0 === this.situation.loops || i < this.situation.loops ? (this.pos = e - i, n = this.situation.loop, this.situation.loop = i) : (this.absPos = this.situation.loops, this.pos = 1, n = this.situation.loop - 1, this.situation.loop = this.situation.loops), this.situation.reversing && (this.situation.reversed = this.situation.reversed != Boolean((this.situation.loop - n) % 2))
        ...
        x: function (t, e) {
            if (this.target() instanceof w.G) return this.transform({
                x: t
            }, e), this;
        ...
        create: function (t, e, i, n) {
            if (!("object" != typeof t || t instanceof w.Element)) return w.Box.call(this, null != t.left ? t.left : t.x, null != t.top ? t.top : t.y, t.width, t.height);
            4 == arguments.length && (this.x = t, this.y = e, this.width = i, this.height = n), y(this)
        },
        extend: {
            merge: function (t) {
        ...
        extend: {
            ...
            skew: function (t, e, i, n) {
                return 1 == arguments.length ? e = t : 3 == arguments.length && (n = i, i = e, e = t), t = w.utils.radians(t), e = w.utils.radians(e),
        ...
        transform: function (t, e) {
            ...
            if (i = new w.Matrix(r), e = !!e || !!t.relative, null != t.a) i = e ? i.multiply(new w.Matrix(t)) : new w.Matrix(t);
            else if (null != t.rotation) p(t, r), i = e ? i.rotate(t.rotation, t.cx, t.cy) : i.rotate(t.rotation - i.extract().rotation, t.cx, t.cy);
        ...
        create: function (t, e) {
            ...
            if (Array.isArray(t))
                ...
                for (var i = 0, n = this.arguments.length; i < n; ++i) this[this.arguments[i]] = t[this.arguments[i]];
        ...
        create: function (t) {
            var e, i, n, r, s, o, a, h = [0, 0, 0, 0],
                u = 1,
                l = 1,
                c = /[+-]?(?:\d+(?:\.\d*)?|\.\d+)(?:e[+-]?\d+)?/gi;
            if (t instanceof w.Element) {
                for (o = t, a = t, s = (t.attr("viewBox") || "").match(c), t.bbox, n = new w.Number(t.width()), r = new w.Number(t.height());
                    "%" == n.unit;) u *= n.value, n = new w.Number(o instanceof w.Doc ? o.parent().offsetWidth : o.parent().width()), o = o.parent();
                for (;
                    "%" == r.unit;) l *= r.value, r = new w.Number(a instanceof w.Doc ? a.parent().offsetHeight : a.parent().height()), a = a.parent();
                ...
                return parseFloat(t)
            }) : Array.isArray(t) ? t : "object" == typeof t ? [t.x, t.y, t.width, t.height] : 4 == arguments.length ? [].slice.call(arguments) : h, this.x = t[0], this.y = t[1], this.width = t[2], this.height = t[3]
        },
        extend: {
            toString: function () {
        ...
        if (-1 != n)
            ...
            for (e in w.listeners[n])
                for (o in w.listeners[n][e]) s === o && w.off(t, [e, s].join("."));
        else if (r) {
            if (w.listeners[n][r]) {
        ...
        create: function (t, e) {
            if (this.constructor.call(this, w.create(t)), e)
    ...
    ["fill", "stroke"].forEach(function (t) {
        ...
        i[t] = function (i) {
            ...
            if ("string" == typeof i || w.Color.isRgb(i) || i && "function" == typeof i.fill) this.attr(t, i);
                ...
                for (e = M[t].length - 1; e >= 0; e--) null != i[M[t][e]] && this.attr(M.prefix(t, M[t][e]), i[M[t][e]]);
            return this
    ...
    if ("function" != typeof t.CustomEvent) {
        ...
        k.prototype = t.Event.prototype, w.CustomEvent = k
